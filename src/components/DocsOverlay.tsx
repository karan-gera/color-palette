...
const CHANGELOG = [
  {
    ...
    items: [
      'screen readers announce recovery alerts and transient status messages',
      'open and save dialogs restore focus to the control that opened them',
  ...
  },
  {
    ...
    items: [
      ...
      'try again and reload actions preserve local palettes',
